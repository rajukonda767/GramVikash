...
export const translations = {
  ...
  te: {
    ...
    pmKisanReply: "పీఎం కిసాన్ పథకం ద్వారా రైతులకు ��ంవత్సరానికి ఆరు వేల రూపాయలు మూడు విడతలుగా రెండు వేల రూపాయల చొప్పున ప్రభుత్వం అందిస్తుంది.",
